<template>
  <div class="player-profile">
    <div
      class="w-3/5 cursor-pointer border b-gray-400 rounded flex flex-col justify-center items-center text-center p-6 bg-white m-8"
    >
      ...
      <div class="flex justify-between w-full">
        <div class="flex items-center text-gray-700 px-2">
          ...
          Projected Games Played: {{ currentBatter.G }}
        </div>
        <div class="flex items-center text-gray-700 px-2">
          <svg
            class="mr-2 h-4 w-4"
          ...
          Projected WAR: {{ currentBatter.WAR }}
        </div>
      </div>
    </div>
  </div>
