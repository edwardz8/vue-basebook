    ...
    <div class="w-full cursor-pointer border b-gray-400 rounded flex flex-col p-6 bg-white m-8">
      ...
      <div class="column-right">
        <div class="w-2/5 px-3 form">
          <div v-show="batterComments.length" class="comments">
            <div v-for="(comment, index) in batterComments" :key="index" class="comment">
...
export default {
  ...
  methods: {
    ...
    addComment() {
      ...
      let batterComments = this.comment.batterComments;
