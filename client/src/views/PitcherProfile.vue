<template>
  <div class="player-profile">
    <div
      class="w-11/12 flex flex-wrap justify-between cursor-pointer border b-gray-400 rounded p-2 bg-white m-4 card"
    >
      <div class="column-left justify-center items-center text-center pl-8">
        <div class="fixed-player-info">
          <div class="text-md font-bold flex flex-col text-gray-900">
            ...
            <span class="font-normal text-gray-700 text-md">{{ currentPitcher.Team }}</span>
          </div>
        ...
        <h3 class="text-black mb-6 mt-4 projections-text">Pitcher Projections</h3>
